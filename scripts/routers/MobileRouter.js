define(['collections/sidemenusCollection', 'selfies/navigation/PanelrightView', 'selfies/navigation/PanelfunctionsView', 'selfies/navigation/TestView', 'views/template/TemplateView', 'views/noaccess/NoaccessView'
			, 'views/users/UsersView', 'views/videos/VideosView', 'views/cards/CardsView', 'parser/simpletext/simpletextView', 'views/restore/RestoreView', 'views/learningstream/LearningstreamView', 'views/messages/MessagesView'
    ...
    function(sidemenusCollection, panelrightView, panelfunctionsView, testView, templateView, noaccessView
			, usersView, videosView, cardsView, simpletextView, restoreView, learningstreamView, messagesView
			, messageView
			) {
